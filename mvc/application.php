...
<a href="<?php echo $site_url; ?>/print/application-print-back.php?client_id=<?php echo $client_id;?>" target="_blank"><button type="button" class="btn btn-danger" style="float: right; margin-right: 9px;">Print Back</button></a>
<a href="<?php echo $site_url; ?>/print/application-print-front.php?client_id=<?php echo $client_id;?>" target="_blank"><button type="button" class="btn btn-danger" style="float: right; margin-right: 9px;">Print Front</button></a>
...
<table width="100%">
	...
	<tr>
		...
		<td>4. Mother: <?php echo strtoupper($client_mother_name); ?></td>
		<td>5. Nationality: <?php echo strtoupper($client_nationality); ?></td>
	</tr>
	<tr>
		<td>6. Sex: <?php echo strtoupper($gender_name); ?></td>
		<td>7. Guardian's name: </td>
	</tr>
	<tr>
		<td colspan="2">8. Owner's Address (One only): <?php echo strtoupper($client_village); ?></td>
	</tr>
	<tr>
		<td>9. Phone No. (if any): <?php echo strtoupper($client_phone); ?></td>
		<td>10. PO/Bank:</td>
	</tr>
	<tr>
		<td>11. Joint owner:</td>
		<td>12. Owner type:</td>
	</tr>
	<tr>
		<td>13. Hire:</td>
		<td>14. Hire purchase:</td>
	</tr>
</table>
...
<table width="100%">
	<tr>
		<td width="50%">15. Vehicle or trailer: MOTOR CYCLE</td>
		<td>16. Prev. Reg. No. (if any): N/A</td>
	</tr>
	<tr>
	...
	<tr>
		<td>17. Type of body: MOTOR CYCLE</td>
		<td>18. Maker's Country: <?php echo strtoupper($bike_country); ?></td>
	</tr>
	<tr>
		<td>19. Color (cabin/body): <?php echo strtoupper($bike_color); ?></td>
		<td>20. Year of manufacture: <?php echo strtoupper($bike_yom); ?></td>
	</tr>
	<tr>
		<td>21. Number of cylinders: <?php echo strtoupper($bike_cylinder); ?></td>
		<td>22. Chassis number: <?php echo strtoupper($bike_chassis_no); ?></td>
	</tr>
	<tr>
		<td>23. Engine number: <?php echo strtoupper($bike_engine_no); ?></td>
		<td>24. Fuel used: <?php echo strtoupper($bike_fuel); ?></td>
	</tr>
	<tr>
		<td>25. Horse power: <?php echo strtoupper($bike_bhp); ?></td>
		<td>26. RPM: <?php echo strtoupper($bike_rpm); ?></td>
	</tr>
	<tr>
		<td>27. Cubic capacity: </td>
		<td>28. Seats (incl. driver): <?php echo strtoupper($bike_seats); ?></td>
	</tr>
	<tr>
		<td>29. No. of Standee: <?php echo strtoupper($bike_cc); ?></td>
		<td>30. Wheel base: <?php echo strtoupper($bike_wb); ?></td>
	</tr>
	<tr>
		<td>31. Unladen weight (kg): <?php echo strtoupper($bike_weight); ?></td>
		<td>32. Maximum laden/train weight (kg): <?php echo strtoupper($bike_maxload); ?></td>
	</tr>
</table>
<br>
...
<table width="100%">
	<tr>
		<td width="50%">33. No of types: 2 (TWO)</td>
		<td>34. Tyres size: <?php echo strtoupper($bike_tyres); ?></td>
	</tr>
	<tr>
		<td>35. No. of axle: 2 (TWO)</td>
		<td>36. Maximum axle weight (kg): </td>
	</tr>
	<tr>
		<td rowspan="3">&nbsp;</td>
...
<table width="100%">
	<tr>
		<td colspan="3">37. Dimensions (mm): </td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="3">39. A copy of the drawing showing the vehicle dimension specifications of the body and of the seating<br>
...
<table width="100%">
	<tr>
		<td colspan="4">
		40. Hire purchase/hypothecation information:<br>
...
<table width="100%">
	<tr>
		<td colspan="4">42. Joint owner information:</td>
	</tr>
	<tr>
		<td>a) Name:</td>
		<td>&nbsp;</td>
