...
<a href="<?php echo $site_url; ?>/print/challan-form-print.php?client_id=<?php echo $client_id;?>" target="_blank"><button type="button" class="btn btn-danger" style="float: right; margin-right: 9px;">Print</button></a>
<br><br>
<div class="container ">
<center>
<h3>চালান ফরম</h3>
...
<table width="20%" border="1" id="table-border" align="right" class="chalantr">
	<tr>
...
<table>
	<td>
		<table width="100" border="1" id="table-border" align="left" class="chalantr">
		<tr>
			<td>১</td>
		</tr>
		</table>
	...
	<td width="100">&nbsp;</td>
	<td>
		<table width="200" border="1" id="table-border" class="chalantr">
			<tr>
	...
	<td>
		<table width="250" border="1" id="table-border" class="chalantr">
			<tr>
...
<table width="100%" border="1" id="table-border">
	<tr>
