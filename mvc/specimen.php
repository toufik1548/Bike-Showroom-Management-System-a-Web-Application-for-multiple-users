...
<?php
	...
	if($client_nid==0){$client_nid="NULL";}else{$client_nid=$client_nid;}

	$client_etin 			= $rc['client_etin'];

	if($client_etin==0){$client_etin="NULL";}else{$client_etin=$client_etin;}
...
<a href="<?php echo $site_url; ?>/print/specimen-print.php?client_id=<?php echo $client_id;?>" target="_blank"><button type="button" class="btn btn-danger" style="float: right; margin-right: 9px;">Print</button></a>
...
<tr>
	<td>1. &nbsp;</td>
	<td>
		<table border="1" id="table-border">
			<tr>
