<br>
<h4 class="fw-bold">location Edit</h4>
<?php
...
<?php
$q = mysqli_query($con,"SELECT *  FROM sms_locations WHERE location_id=$location_id");
...
<form name="form1" method="POST" action="">
  <div class="mb-3">
      <input type="text" name="location_name" class="form-control" id="text" placeholder="location Name" value="<?php echo $r['location_name'];?>">
  </div>
