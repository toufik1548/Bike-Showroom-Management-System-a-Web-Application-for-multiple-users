<br>
<h4 class="fw-bold">Country Edit</h4>
<?php
...
<?php
$q = mysqli_query($con,"SELECT *  FROM sms_country WHERE country_id=$country_id");
...
<form name="form1" method="POST" action="">
  <div class="mb-3">
      <input type="text" name="country_name" class="form-control" id="text" placeholder="Country Name" value="<?php echo $r['country_name'];?>">
  </div>
